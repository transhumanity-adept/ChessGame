...
namespace ChessGame.Model
{
    ...
    /// Игра шахматы
    /// </summary>
    public class ChessParty : NotifyPropertyChanged
    {
        #region Поля
        ...
        #region Конструкторы
        public ChessParty(DateTime save_date, Game game, int white_total_seconds, int black_total_seconds)
        {
            SaveDate = save_date;
        ...
        public ChessParty(DateTime save_date, Game game, string restore_state_info)
        {
            SaveDate = save_date;
            RestoreState(game, restore_state_info);
            _one_second_timer.Elapsed += TimerElapsed;
            _one_second_timer.Start();
        }
        #endregion
        ...
        private void RestoreState(Game game, string restore_state_info)
        {
            ...
            Board restored_board = new Board(this, game, game_info[2]);
