...
namespace ChessGame.ViewModel.Converters
{
    ...
    public class BackgroundCellConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            radiuse_rect.Rect = new Rect(150, 150, 200, 200);
            ...
            if ((CellColors)value == CellColors.White)
            {
                ...
                radiuse_rect_path.Fill = fill_color_brush;
                ...
                drawingGroup.Children.Add(new GeometryDrawing(fill_color_brush, new Pen(fill_color_brush, 1), radiuse_rect));
